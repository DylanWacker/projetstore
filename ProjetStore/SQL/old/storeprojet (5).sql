...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 25 Juillet 2016 à 13:03
...
INSERT INTO `store` (`IdStore`, `NomStore`, `PrixStore`, `PoidStore`, `Photo`, `TailleMin`, `TailleMax`, `IdTypeCommande`, `IdType`) VALUES
(1, 'store ultime', 200, 10, 'Store1.jpg', 165, 600, 1, 1),
(2, 'twix Store', 100, 200, 'Store2.jpg', 165, 600, 2, 2);
...
(1, 'Store Exterieur', 'TypeStore1.jpg'),
(2, 'Store Intérieur', 'TypeStore2.jpg'),
(3, 'Rideaux voilage', 'TypeStore3.jpg'),
(4, 'Volets roulant', 'TypeStore4.jpg');
